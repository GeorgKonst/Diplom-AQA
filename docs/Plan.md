...
#### 2. Покупка тура дебетовой картой сто статусом DECLINED
1. Нажать кнопку "Купить"
...
#### 3. Покупка тура в кредит дебетовой картой сто статусом APPROVED
...
#### 4. Покупка тура в кредит картой сто статусом DECLINED
1. Нажать кнопку "Купить в кредит"
2. Ввести номер карты со статусо DECLINED
3. В поле месяц ввести число от 1 до 12 (2 знака)
4. В поле год ввести 22
...
1. Открыть приложение (http://localhost:8080/)
2. Выбрать способ оплаты (Все сценарии проводятся дважды используя два способа оплаты)
...
* Время автоматизации сильно превысит ручное тестирование
